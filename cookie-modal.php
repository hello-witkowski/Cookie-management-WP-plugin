...
class cookieModal
{
    ...
    public function link_scripts()
    {
        ...
        wp_register_script('jquery-browser','https://cdnjs.cloudflare.com/ajax/libs/jquery-browser/0.1.0/jquery.browser.min.js', ['jquery'], PLUGIN_VERSION, true);
        wp_register_script('cm-modal-js', plugins_url('/', __FILE__) . 'templates/js/modal.js', ['jquery'], PLUGIN_VERSION, true);
        wp_localize_script('cm-modal-js', 'php', array(
            "ajax_url" => admin_url('admin-ajax.php', 'relative'),
        ));
        wp_enqueue_script('jquery-browser');
        wp_enqueue_script('cm-modal-js');
        wp_enqueue_script('cm-jqueryui-js', plugins_url('/', __FILE__) . 'templates/js/jquery-ui.min.js', ['jquery'], PLUGIN_VERSION, false);
